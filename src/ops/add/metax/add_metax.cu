// =============================================================
// MetaX (沐曦) C500 — Add kernel
// 移植自 NVIDIA CUDA 实现，替换头文件和类型
// =============================================================
...
#include <maca_bf16.h>
#else
// Stub: 在没有 MXMACA SDK 时，使用 CUDA 兼容头文件
// 沐曦 MXMACA 兼容 CUDA kernel 语法，编译时由 mxcc 处理
...
void add(std::byte *c, const std::byte *a, const std::byte *b, llaisysDataType_t type, size_t numel) {
    ...
    case LLAISYS_DTYPE_BF16:
        ...
        break;
    default:
        throw std::runtime_error("MetaX add: unsupported dtype");
    }
